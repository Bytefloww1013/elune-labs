...
## Operating Context
- **Catalog:** peptides only, in five research categories — GLPs, Bioregulators, Recovery, GH Releasing, Other — with per-size simple products. Size-paired SKUs (BPC-157, TB-500, CJC-1295 No DAC) share a native EverShop Size variant group; each child remains its own SKU, price, and stock.
