...
export default {
  Setting: {
    cryptoWalletBtc: (setting) =>
      railAddress(setting, 'crypto_wallet_btc', isBitcoinAddress),
    cryptoWalletUsdt: (setting) =>
      railAddress(setting, 'crypto_wallet_usdt', isErc20Address),
    cryptoWalletEth: (setting) =>
      railAddress(setting, 'crypto_wallet_eth', isErc20Address),
